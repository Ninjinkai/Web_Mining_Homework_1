...
public void initialize(String[] argv) {
	...
	Properties newprops = new Properties(props);System.setProperties(newprops);
	*/
}
...
//Go through page finding links to URLs.  A link is signaled
	...
	while ((index = lcPage.indexOf("<a",index)) != -1)
	{
		...
		if (ihref != -1) 
		{
			...
			if ((iURL != -1) && (iEndAngle != -1) && (iURL < iEndAngle))
			{
				...
				{
					iEnd = iCloseQuote;
					if ((iHatchMark != -1) && (iHatchMark < iCloseQuote)) iEnd = iHatchMark;
